...
public static class SystemLeakLinter
{
    ...
    private static readonly List<LeakPattern> Patterns = new()
    {
        ...
        new(new Regex(@"\bInsulation\b", RegexOptions.IgnoreCase | RegexOptions.Compiled), "Engine Bias & Gift Names", "Insulation bias name leak"),
        new(new Regex(@"\bDissolution\b", RegexOptions.IgnoreCase | RegexOptions.Compiled), "Engine Bias & Gift Names", "Dissolution bias name leak"),
