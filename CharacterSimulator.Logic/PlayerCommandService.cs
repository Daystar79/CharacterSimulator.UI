...
public static class PlayerCommandService
{
    private static readonly Dictionary<string, PlayerCommandKind> Aliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["auto"] = PlayerCommandKind.AutoPlay,
        ["autoplay"] = PlayerCommandKind.AutoPlay,
        ["guided"] = PlayerCommandKind.PlayerGuided,
        ["player"] = PlayerCommandKind.PlayerGuided,
    ...
    public static string GetHelpText()
    {
        return string.Join("\n", new[]
        {
            ...
            "  /guided            Switch to Player-Guided mode",
